...
@stop
{{--*/ $imgcounts = '1' /*--}}
 @if(!empty($data['article']['article_image']) && count($data['article']['article_image']) > 0)
    {{--*/ $imgcounts = count($data['article']['article_image']) /*--}}
@endif
                                        ...
                                        <div class="box-body" id="remove_en{{$key}}">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3">
                                                    ...
                                                    <img src="{{ asset('uploads/' . $images['image']) }}" height="80" /><br>
